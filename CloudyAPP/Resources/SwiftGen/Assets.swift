...
internal enum Asset {
  ...
  internal static let buttonLocationNormal = ImageAsset(name: "button-location-normal")
  internal static let buttonSettingsNormal = ImageAsset(name: "button-settings-normal")
